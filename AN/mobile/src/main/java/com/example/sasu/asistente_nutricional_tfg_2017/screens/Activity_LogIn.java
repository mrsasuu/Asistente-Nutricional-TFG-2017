...
public class Activity_LogIn extends AppCompatActivity implements LoginFragment.OnFragmentInteractionListener, RegistrationFragment.OnFragmentInteractionListener {
...
/*
    ...
    public void onBackPressed() {
        super.onBackPressed();
        FragmentManager fragmentManager = getSupportFragmentManager();
        Toast.makeText(this,Integer.toString(fragmentManager.getBackStackEntryCount()),
